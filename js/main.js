...
label.addEventListener("click", function () {
  ...
  if (search.value.length > 0) {
    ...
    li.innerHTML = li.innerHTML + newToDo;
...
var randomPlaceholderShit = function randomPlaceholderShit() {
...
var checkLogo = function checkLogo() {
...
var checkToDoItems = function checkToDoItems() {
